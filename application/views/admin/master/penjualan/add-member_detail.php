  ...
  <section class="content">
  	<div class="box box-info">
  		...
  		<div class="box-body">
  			...
  			<?php echo form_open('admin/addtpj_memberdetail/?nofak='.$trxid.'&idmember='.$memberid.'&tgltrx='.$trxDate.'',$attribute); ?>
  			<div class="col-md-2">
  			...
  			<div class="col-md-12">
  				...
  				<div class="col-md-2">
  					<div class="form-group">
  						<p>Stok di gudang : <input class="form-control" type="text" name="tgltrx" id="stokproduk"  readonly/></p>
  					</div>
  				</div>
  				<div class="col-md-2">
  					<div class="form-group has-warning">
  											...
  											else if($r->productDiscounttype=="2")
  											{
  												...
  												<td>
  													<div class="btn-group" role="group">
  														...
  														<a href="<?php echo base_url(); ?>admin/hapus_trxpj?idtrxpj=<?php echo $r->detailID ?>&productBarcode=<?php echo $r->productBarcode; ?>&qtyremove=<?php echo $r->detailQty ?>&nofak=<?php echo $trxid;?>&idmember=<?php echo $memberid;?>&tgltrx=<?php echo $trxDate; ?>" onclick="javascript: return confirm('Anda akan menghapus item : <?php echo $r->productName; ?> ?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
  													</div>
  												</td>
  											</tr>
  											<?php 
  			...
  			<div class="box box-info">
  				<div class="box-header with-border">
  					<h4>Data Member Dan Pengiriman</h4>
  				</div> 
  				<?php  
  				...
  				<div class="col-md-4">
  					...
  					<div class="form-group">
  						...
  						Tujuan Pengiriman :
  						<input type="text"  class="form-control" name="namamember2" value="<?php echo $data->memberFullName; ?>" />
  					</div>
  					<div class="form-group">
  						Alamat Pengiriman :
  						<input type="text" class="form-control" name="alamatkirim" value="<?php echo $data->memberAddress; ?>" />
  					</div>
  					<div class="form-group">
  						No telp Tujuan Pengiriman :
  						<input type="text" class="form-control" name="telpkirim" value="<?php echo $data->memberPhone; ?>" />
  					</div>
  				...
  				<div class="col-md-4">
  					<div class="form-group">
  						...
  						<div class="form-group">
  							<br/><br/>
  							Zona :
  							<input type="text" class="form-control" name="zona" value="<?php echo $data->memberzone; ?>" />
  						</div>
  					</div>
  					<div class="col-md-12">
  						<div class="form-group has-warning">
  			...
  			<div id="dialog" style="display: none" align = "center">
  				<!-- form start -->
  				<?php echo form_open('admin/addtpj_memberdetail/?nofak='.$trxid.'&idmember='.$memberid.'&tgltrx='.$trxDate.''); ?>
  				<div class="form-group">
  					<input type="hidden" name="productbarcode" id="productbarcode">
  					<input type="hidden" name="nofak" value="<?php echo $trxid;?>">
  					<input type="hidden" name="editmemberid" value="<?php echo $idmember;?>">
