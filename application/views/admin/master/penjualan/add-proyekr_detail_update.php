  ...
  <section class="content">
  	<div class="box box-info">
  		...
  		<div class="box-body">
  			...
  			<?php echo form_open('admin/addtpj_memberdetailproyekupdate/?nofak='.$trxid.'&idproyek='.$idproyek.'&tgltrx='.$trxDate.'',$attribute); ?>
  			<div class="col-md-2">
  											...
  											else if($r->productDiscounttype=="2")
  											{
  												...
  												<td>
  													<div class="btn-group" role="group">
  														...
  														<a href="<?php echo base_url(); ?>admin/hapus_trxpj?idtrxpj=<?php echo $r->detailID ?>&productBarcode=<?php echo $r->productBarcode; ?>&qtyremove=<?php echo $r->detailQty ?>&nofak=<?php echo $trxid;?>&idproyek=<?php echo $idproyek;?>&tgltrx=<?php echo $trxDate; ?>" onclick="javascript: return confirm('Anda akan menghapus item : <?php echo $r->productName; ?> ?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
  													</div>
  												</td>
  											</tr>
  											<?php 
